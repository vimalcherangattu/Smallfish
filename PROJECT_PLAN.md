...
|---|---|---|---|
| 0 · Prove it | **In progress** | Coverage ≥ 70% and precision ≥ 90% on 3 niches | **dental** (1 criterion): 2 PASSES 100% · 3 undecided 55% · 4 passes $0.029. **med spa** (2 criteria, scoped): **4 FAILS at $0.137**, couldn't-tell 35.0% ✗. One criterion passes, two criteria fail — the difference is arithmetic, not accuracy |
