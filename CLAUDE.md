...
| `src/` | The Next.js app: map region picker, criteria, results with proof. |
| `public/data/` | Measured data the app serves, generated by `stage0/src/coverage/export_app_data.py`. Regenerate after any new probe run. |
